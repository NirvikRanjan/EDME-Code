...
$(function(){
        $('.slide-out-div1').tabSlideOut({
            ...
            pathToTabImage: '/assets/images/vehicelGif4.gif',
	...
	$(function(){
        $('.slide-out-div2').tabSlideOut({
           ...
           pathToTabImage: '/assets/images/ServiciNFO.gif', //path to the image for the tab //Optionally can be set using css
            imageHeight: '122px',                     //height of tab image           //Optionally can be set using css
            imageWidth: '40px',                       //width of tab image            //Optionally can be set using css
            tabLocation: 'right',                      //side of screen where tab lives, top, right, bottom, or left
            speed: 300,                               //speed of animation
	...
	$(function(){
        $('.slide-out-div3').tabSlideOut({
            ...
            pathToTabImage: '/assets/images/insurance.gif', //path to the image for the tab //Optionally can be set using css
            imageHeight: '122px',                     //height of tab image           //Optionally can be set using css
            imageWidth: '40px',                       //width of tab image            //Optionally can be set using css
            tabLocation: 'right',                      //side of screen where tab lives, top, right, bottom, or left
            speed: 300,                               //speed of animation
